...
const BlogPage = ({ postData }) => {
  ...
  // Trouver l'index de l'article actuel dans fakeData
  // Pour cet exemple, nous supposons que l'article 2 est à l'index 1 (base 0)
  const currentIndex = 1;

  // Récupérer les articles précédent et suivant en utilisant cet index
